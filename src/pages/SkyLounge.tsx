          ...
          <div className="lg:col-span-2 space-y-8">
            <div>
              <h2 className="text-4xl font-orbitron font-bold mb-6 bg-gradient-primary bg-clip-text text-transparent">
                Panoramic Views from Sky Lounge
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Rise above the excitement at Sky Lounge, where breathtaking panoramic views meet exceptional hospitality. Positioned at an elevated vantage point, this premium venue offers unobstructed sightlines across the entire Marina Bay Street Circuit, giving you the ultimate perspective on Formula 1 racing.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                The Sky Lounge's floor-to-ceiling windows and spacious outdoor terraces provide the perfect blend of comfort and spectacle. Watch as cars navigate the challenging street circuit while enjoying world-class dining and premium service in an atmosphere of modern elegance.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                With its contemporary design and sophisticated ambiance, Sky Lounge is ideal for corporate entertainment, special occasions, or simply treating yourself to an unforgettable Formula 1 experience with friends and family.
              </p>
            </div>
